  ...
  return (
    <div className="board">
      <div className="row">
        ...
        <LetterBox index={6} attempt={0} board={board}/>
      </div>
      <div className="row">
        ...
        <LetterBox index={6} attempt={1} board={board}/>
      </div>
      <div className="row">
        ...
        <LetterBox index={6} attempt={2} board={board}/>
      </div>
      <div className="row">
        ...
        <LetterBox index={6} attempt={3} board={board}/>
      </div>
      <div className="row">
        ...
        <LetterBox index={6} attempt={4} board={board}/>
      </div>
    </div>
  );
}